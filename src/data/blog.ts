...
const RECIENTES: Reciente[] = [
  ...
  },
  {
    ...
    cuerpo: [
      ...
      'Dedicar tiempo a un pacto de socios puede evitar conflictos difíciles más adelante. Conviene revisarlo con un profesional antes de firmarlo.',
      'Este contenido es informativo y general: no sustituye el asesoramiento jurídico adaptado a tu caso concreto. Cada sociedad y cada pacto tienen particularidades que conviene revisar con un profesional.',
    ],
